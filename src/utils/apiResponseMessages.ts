...
export type NotFoundErrorCode = "notFound" | "unSupportedProtocol";
...
export const API_RESPONSE_MESSAGES: ApiResponseMessages = {
  ...
  badRequest: {
    ...
    invalidParameter:
      "The request failed because it contained an invalid parameter",
    invalidHeader: "The request failed because it contained an invalid header.",
    invalidQuery:
      "The request failed because of invalid query parameter. Check Api documentation for query parameter combinations.",
  ...
  conflict: {
    ...
    conflict:
      "The request cannot be completed because the requested operation would conflict with an existing item.",
  },
  gone: {
    deleted:
